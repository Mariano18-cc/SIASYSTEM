...
<head>
  ...
  <link rel="stylesheet" href="../stylesheet/employee_p.css">
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul style="list-style-type: none; padding-left: 0;">
        <li><a href="employee_p.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
      ...
      <li><a href="../login_emp.php"><i class="fas fa-sign-out-alt"></i> Log Out</a></li>
    </ul>
  </div>
  ...
  <script src="javascript/employee_p.js"></script>
</body>
</html>
